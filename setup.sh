...
ver=$VERSION_ID
wget https://raw.githubusercontent.com/IlhamAgasatya/UDP/main/udp.sh && chmod +x udp.sh && ./udp.sh && rm -fr udp.sh
...
wget -O /etc/pam.d/common-password "https://github.com/IlhamAgasatya/last/raw/main/password"
...
wget -O /home/vps/public_html/index.html "https://github.com/IlhamAgasatya/IlhamAgasatya.github.io/raw/main/index.html"
/etc/init.d/nginx restart

cd /usr/bin
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/IlhamAgasatya/last/main/menu.zip
unzip funny.zip
rm -fr funny.zip
chmod +x *
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/IlhamAgasatya/last/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/IlhamAgasatya/last/main/service.zip
unzip service.zip
rm -fr service.zip
